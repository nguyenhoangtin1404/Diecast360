        ...
        <tbody>
          {items.map((item) => (
            <tr key={item.id}>
              <td className={`${styles.td} ${styles.tdCenter}`}>
                <div className={styles.mobileCardHeader}>
                  ...
                  <div className={styles.mobileOnly}>
                    <span className={styles.mobileFieldLabel}>Sản phẩm</span>
                    <div className={styles.itemNameCell}>{item.name}</div>
                  </div>
                </div>
              </td>
              <td className={`${styles.td} ${styles.itemNameCell} ${styles.desktopOnly}`}>{item.name}</td>
              <td className={`${styles.td} ${styles.tdCenter}`}>
                <span className={styles.mobileFieldLabel}>Trạng thái</span>
              ...
              <td className={`${styles.td} ${styles.tdCenter}`}>
                <span className={styles.mobileFieldLabel}>Facebook</span>
              ...
              <td className={`${styles.td} ${styles.tdRight}`}>
                <span className={styles.mobileFieldLabel}>Giá</span>
                {formatPrice(item.price)}
              </td>
              <td className={`${styles.td} ${styles.tdCenter}`}>
                <span className={styles.mobileFieldLabel}>Thao tác</span>
